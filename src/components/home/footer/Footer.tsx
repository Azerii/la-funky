...
import insta_img1 from "../../../assets/images/insta_img1.jpg"
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12">
                      <div className="widget">
                            ...
                            <ul className="widget_instafeed instafeed_col4">
                                <li><a href="#"><img src={insta_img1} alt="insta_img"/><span className="insta_icon"><i className="ti-instagram"></i></span></a></li>
                                <li><a href="#"><img src={insta_img1} alt="insta_img"/><span className="insta_icon"><i className="ti-instagram"></i></span></a></li>
                                <li><a href="#"><img src={insta_img1} alt="insta_img"/><span className="insta_icon"><i className="ti-instagram"></i></span></a></li>
                                <li><a href="#"><img src={insta_img1} alt="insta_img"/><span className="insta_icon"><i className="ti-instagram"></i></span></a></li>
                                <li><a href="#"><img src={insta_img1} alt="insta_img"/><span className="insta_icon"><i className="ti-instagram"></i></span></a></li>
